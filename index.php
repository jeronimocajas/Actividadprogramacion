...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <header class="masthead">
            <div class="container">
                <div class="masthead-subheading">Bienvenido a Airplane </div>
                <div class="masthead-heading text-uppercase">Antes de iniciar tu experiencia registrate</div>
                <a class="btn btn-primary btn-xl text-uppercase" href="./paginas/login.php">INICIAR SESION</a>
            </div>
        </header>
